...
/***/ function(module, exports) {
	...
	(function (window, document) {
	  ...
	  function showModal() {
	    ...
	    switch (typeof arguments[0]) {
	      ...
	      case 'object':
	        ...
	        params.logo = arguments[0].logo || defaultParams.logo;
	  ...
	  var setParameters = function (params) {
	    ...
	    if (params.logo) {
	      var $customLogo = document.getElementById('bmalert-custom-logo');
	      var logoIsUrl = true;
	      var $bmIcon = document.getElementById(window.bmalertIDs.bm);
	      window.bmalertIDs.bm = 'bmalert-custom-logo';
	      $bmIcon.style.display = 'none';
	      if (params.logo.search(/\<svg/) >= 0 && params.logo.search(/\<\/svg\>/) > 0) {
	        logoIsUrl = false;
	      }
	      if (logoIsUrl) {
	        var customLogoImg = document.createElement('img');
	        customLogoImg.setAttribute('src', params.logo);
	        $customLogo.innerHTML = '';
	        $customLogo.appendChild(customLogoImg);
	        $customLogo.style.display = 'block';
	      } else {
	        $customLogo.style.display = 'block';
	        $customLogo.innerHTML = params.logo;
	      }
	    }
	  ...
	  window.bmalert.init = function () {
	    ...
	    var bmalertHTML = '<div id="bmalert-prompt">' + '<div id="bmalert-logo">' + defaultLogo + '<div id="bmalert-custom-logo">' + '</div>' + '</div>' + '<h1 id="bmalert-title" class="bmalert-title">Seguro?</h1>' + '<div id="bmalert-btns">' + '<button id="bmalert-cancel" class="bmalert-cancel">Si</button>' + '<button id="bmalert-confirm" class="bmalert-confirm">No</button>' + '</div' + '</div>';
